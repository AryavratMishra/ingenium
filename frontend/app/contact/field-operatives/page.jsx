...
export default function FieldOperativesPage() {
        ...
        <PageTransitionWrapper>
            <main className="relative min-h-screen bg-black/30 text-slate-200 selection:bg-emerald-500/40 overflow-x-hidden font-sans">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
                    {/* TOP NAV BAR */}
                    <nav className="flex flex-col md:flex-row justify-between items-center mb-10 pb-6 border-b border-emerald-500/10">
