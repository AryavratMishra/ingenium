...
export default function FictionRelayPage() {
    ...
    const item = {
        ...
        registrationPath: "/present/registration?competition=fr",
        description:
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-12 border-b border-amber-500/20 pb-8">
                    <div className="space-y-1">
                        ...
                        <h1 className="text-5xl font-black tracking-tighter text-white uppercase italic">
                            FICTION <span className="text-amber-500/40">RELAY</span>
                        </h1>
...
function BountyNode({ rank, amount }) {
    return (
        <div className="text-center group">
            <div
                className={`text-[10px] font-bold uppercase mb-1 text-amber-500/60`}
            >
                {rank}_ACCESS
            </div>
