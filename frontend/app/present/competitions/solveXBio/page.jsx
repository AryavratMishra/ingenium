  ...
  const medicalBriefs = [
    ...
    },
    {
      ...
      requirements: [
        {
          label: "Mechanism",
          desc: "Clear explanation of detection logic and stress tracking.",
        },
        {
          label: "Intervention",
        ...
        },
        {
          ...
          desc: "Non-intrusive long-term behavior modification.",
        },
        {
          label: "Tech Stack",
          desc: "Software and hardware integration plan.",
        },
      ],
      deliverables: [
        "Concept note of the technology stack",
        "User workflow detailing system interaction",
        "Impact analysis on health",
      ],
    },
  ];
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-12 border-b border-emerald-500/30 pb-8 gap-6">
          <div className="space-y-2">
            ...
            <p className="text-[14px] text-emerald-500/60 tracking-[0.3em] uppercase">
              Biotech & Biomedical Challenge (Offline Mode)
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full lg:w-auto">
            <HeaderTag
              icon={<Boxes size={14} />}
              label="Participation"
              value={medicalBriefs[activeTab].teamSize}
            />
            <HeaderTag
              icon={<Wallet size={14} />}
              label="Reg Fee"
              value={`₹${medicalBriefs[activeTab].fee}`}
            />
            <HeaderTag
              icon={<Target size={14} />}
              label="Format"
                ...
                <div className="flex flex-col md:flex-row gap-6 items-center border-t border-emerald-500/20 pt-8">
                  ...
                  <div className="shrink-0 w-full md:w-auto">
                    <button
                      onClick={() =>
                        router.push(
                          `/present/registration?competition=${activeTab === 0 ? "patient_monitor" : "screen_addiction"}`,
                        )
                      }
                    ...
                    >
                      <Cpu size={18} />
                      START REGISTRATION (₹{medicalBriefs[activeTab].fee})
                      <ArrowRight size={16} />
                    </button>
                  </div>
                </div>
