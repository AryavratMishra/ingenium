...
export default function GroupDancePS() {
  ...
  const competitionData = {
    ...
    org: "Kaizen Dance Crew, IIT Indore",
    teamSize: "5-35 members",
    duration: "5-15 mins total",
    music: "5-13 mins long",
    mode: "Offline",
    prizes: {
      first: "10,000",
      second: "6,000",
    ...
    phases: [
      {
        ...
        detail:
          "Online registration and MP3 track submission (min 5m, max 13m).",
      },
      {
        id: "BRIEF",
        title: "Technical Briefing",
        detail:
          "Mandatory session for stage dimensions, sound, and slot allocation.",
      },
      {
        id: "LIVE",
        title: "Performance Day",
        detail:
          "Sound check, high-energy routine execution, and stage cleanup.",
      },
    ],
  };
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-12 border-b border-pink-500/20 pb-8">
          <div className="space-y-1">
            ...
            <p className="text-[12px] text-pink-400/60 mt-2 tracking-[0.3em] uppercase">
              Blending Technical Excellence & Artistic Diversity
            </p>
          </div>
          <div className="mt-6 lg:mt-0 flex flex-col items-end gap-6">
            ...
            <button
              onClick={() => router.push(`/present/registration?competition=dance`)}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            <h3 className="text-[12px] text-pink-500 uppercase tracking-widest mb-4 font-bold">
              Operational_Context
            </h3>
            <div className="p-6 bg-pink-900/10 border border-pink-500/20 rounded-2xl backdrop-blur-md">
              <p className="text-sm leading-relaxed text-pink-100/80 mb-6 italic border-l-2 border-pink-500 pl-4">
                "Where collaborative artistry meets technical precision,
                blending various styles, cultures, and narratives."
              </p>
              <div className="space-y-4">
                <ObjectiveItem text="Multi-style integration encouraged" />
                <ObjectiveItem text="Original choreography rewarded" />
                <ObjectiveItem text="Professional stage & audio setup" />
              </div>
            </div>
            ...
            <div className="p-6 bg-red-950/20 border border-red-500/20 rounded-2xl">
              ...
              <div className="space-y-2 text-[12px] text-red-200/50 uppercase font-bold italic mb-4">
                <p>▪ Copied Choreo ({">"}15 sec): -10 Score Pts</p>
                <p>▪ Dirty/Damaged Stage: -30 Pts / DQ</p>
                <p>▪ Overtime ({">"}16 min): Music Stop + -50 Pts</p>
              </div>
              <Link
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-xl font-black text-white uppercase tracking-widest mb-10 flex items-center gap-3">
                  <Star className="text-pink-500" /> Progression_Lifecycle
                </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
                  {competitionData.phases.map((phase, idx) => (
                    <button
                      ...
                      className={`p-4 text-left border rounded-xl transition-all ${activeTab === idx ? "bg-pink-500/10 border-pink-500 shadow-[0_0_15px_rgba(236,72,153,0.3)]" : "bg-black/20 border-white/5 hover:border-white/20"}`}
                    >
                ...
                <div className="p-6 bg-pink-500/5 border-l-2 border-pink-500 rounded-r-xl">
                  <p className="text-sm text-pink-100/80 leading-relaxed italic">
              ...
              <div className="mt-12 pt-8 border-t border-white/5 grid grid-cols-2 md:grid-cols-4 gap-6">
                <MetricBox label="Versatility & Choreo" weight="25%" />
                <MetricBox label="Coordination" weight="25%" />
                <MetricBox label="Energy & expressions" weight="15%" />
                <MetricBox label="Innovation/Props" weight="15%" />
              </div>
            </div>
...
function ObjectiveItem({ text }) {
  return (
    <div className="flex gap-3 items-center text-[12px] uppercase font-bold text-gray-400 group">
      ...
      <span className="text-[10px] text-pink-500/30 font-mono"></span>
    </div>
  );
}
...
function MetricBox({ label, weight }) {
  return (
    <div className="text-center p-4 bg-white/5 border border-white/5 rounded-xl group hover:border-pink-500/30 transition-all">
      ...
      <div className="text-[11px] text-white/60 uppercase font-bold tracking-widest mb-1 leading-tight">
        {label}
      </div>
      <div className="text-[10px] text-pink-500/30 font-mono italic"></div>
    </div>
  );
}
...
function BountyNode({ rank, amount, label }) {
  return (
    <div className="text-center group">
      <div className="text-[11px] text-pink-500 uppercase mb-1 font-bold tracking-tighter">
        {rank}_TIER
      </div>
