...
export default function DroneShowPage() {
    ...
    const eventData = {
        ...
        time: "22:30 - 22:50",
        venue: "NCC Ground",
        video: "/events_videos/DroneShow.mp4",
        theme: {
        ...
        description: `A masterclass in swarm intelligence and aerial coordination. The sky above NCC Ground becomes the final canvas of the festival.

Hundreds of custom-built, programmable drones deploy simultaneously to render massive 3D structures, festival logos, and flowing geometric sequences in mid-air. It is the ultimate testament to the engineering prowess celebrated at Ingenium. Look up.`,
        tags: ["SPECTACLE", "AEROSPACE", "SWARM TECH"],
        backgroundElements: (
            <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
                ...
                {[...Array(40)].map((_, i) => (
                    <div
                        key={`drone-${i}`}
                        className="absolute w-2 h-2 rounded-full bg-blue-300 shadow-[0_0_10px_rgba(96,165,250,1)]"
                        style={{
                            top: Math.random() * 50 + 10 + "%",
                            left: Math.random() * 80 + 10 + "%",
                            animation: `drone-formation 6s ease-in-out infinite, pulse ${Math.random() * 2 + 1}s infinite`,
