...
export default function CompetitionsSession2Page() {
    ...
    const eventData = {
        ...
        description: `The final countdown. Session 2 hosts the climactic grand finales of Ingenium's premier competitions.

This is where champions are crowned. Watch as the surviving teams deploy their final code pushes, execute their master strategies, and present their innovations to the judges. The energy in the LHC hits carrying capacity as the festival's technical victors emerge.`,
        tags: ["FINALS", "CHALLENGE", "DAY-2"],
        backgroundElements: (
            <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
                {/* Intense slashes */}
                <div className="absolute top-0 left-[-20%] w-[150%] h-full flex flex-col justify-around py-8 animate-[slash_4s_ease-in-out_infinite]">
                    <div className="w-full h-8 bg-gradient-to-r from-transparent via-purple-500/20 to-transparent -skew-x-45" />
                    <div className="w-full h-12 bg-gradient-to-r from-transparent via-purple-500/10 to-transparent -skew-x-45 translate-x-12" />
                </div>

                {/* Fast Floating triangles */}
                {[...Array(15)].map((_, i) => (
                    <svg
                        key={i}
                        viewBox="0 0 100 100"
                        className="absolute fill-none stroke-purple-400/40 stroke-2"
                        style={{
