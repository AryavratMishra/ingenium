...
export default function DefenseExpositionPage() {
    ...
    const eventData = {
        ...
        video: "/events_videos/defense.mp4",
        theme: {
        ...
        description: `A showcase of cutting-edge military technology and strategic innovations. The Defense Exposition brings together top-tier engineering projects focused on national security, aerospace advancements, and tactical hardware.

Explore next-generation drone systems, autonomous defense vehicles, and advanced software simulations. Engage directly with creators and industry experts pushing the boundaries of protective and strategic technology.`,
        tags: ["EXHIBITION", "DEFENSE", "TECHNOLOGY"],
        backgroundElements: (
            <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
                {/* Scanning laser line */}
                <div className="absolute top-0 left-0 w-full h-1 bg-cyan-400/30 shadow-[0_0_15px_rgba(34,211,238,0.8)] animate-[scanline_4s_linear_infinite]" />

                {/* Crosshair grids */}
                <div className="absolute top-1/4 right-[20%] w-32 h-32 border border-cyan-500/20 opacity-50">
                    <div className="absolute top-1/2 left-[-25%] w-[150%] h-[1px] bg-cyan-500/20" />
                    <div className="absolute left-1/2 top-[-25%] h-[150%] w-[1px] bg-cyan-500/20" />
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 rounded-full border border-cyan-400/40 animate-pulse" />
                </div>

                <div className="absolute bottom-1/4 left-[10%] w-48 h-48 border border-cyan-500/10 opacity-30">
                    <div className="absolute top-1/2 left-[-25%] w-[150%] h-[1px] bg-cyan-500/20" />
                    <div className="absolute left-1/2 top-[-25%] h-[150%] w-[1px] bg-cyan-500/20" />
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 rounded-full border border-cyan-400/40 animate-[ping-slow_3s_infinite]" />
                </div>
            </div>
        ),
    };
