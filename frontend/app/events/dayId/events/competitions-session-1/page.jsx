...
export default function CompetitionsSession1Page() {
    ...
    const eventData = {
        ...
        description: `Day 2 begins with intensity. Session 1 features the advanced rounds of our core technical and cultural competitions.

As brackets narrow and the stakes get higher, witness the top-tier talent battle it out in real-time. Whether it's the finals of the AI hackathon or the crucial judging phase of robotics, the pressure in the Lecture Hall Complex is palpable. Only the optimal algorithms survive.`,
        tags: ["COMPETITION", "CHALLENGE", "DAY-2"],
        backgroundElements: (
            <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
                {/* High speed slashes */}
                <div className="absolute top-0 left-[-20%] w-[150%] h-full flex flex-col justify-around py-8 animate-[slash_6s_ease-in-out_infinite]">
                    <div className="w-full h-4 bg-gradient-to-r from-transparent via-purple-500/10 to-transparent -skew-x-45" />
                    <div className="w-full h-8 bg-gradient-to-r from-transparent via-purple-500/5 to-transparent -skew-x-45 translate-x-12" />
                </div>
                ...
                {[...Array(12)].map((_, i) => (
                    <svg
                        key={i}
                        viewBox="0 0 100 100"
                        className="absolute fill-none stroke-purple-400/30 stroke-2"
                        style={{
