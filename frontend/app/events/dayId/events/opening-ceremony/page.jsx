...
export default function OpeningCeremonyPage() {
    ...
    const eventData = {
        ...
        theme: {
            bg: "from-amber-900/60 to-black",
            accent: "text-amber-500",
            border: "border-amber-500/30",
            buttonBg: "bg-amber-500",
            glow: "shadow-[0_0_40px_rgba(245,158,11,0.4)]",
        },
        description: `The grand inception of Ingenium 2026. Join us as we boot up the system, initialize the core protocols, and welcome dignitaries to officially commence the central technological and cultural phenomenon. 

Experience a spectacle of precision and protocol, setting the stage for days of unprecedented innovation. The ceremony will feature keynote addresses, the unveiling of the festival theme, and a glimpse into the matrix of events that await.`,
        tags: ["PROTOCOL", "INAUGURATION", "DAY-0"],
        backgroundElements: (
            <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
                ...
                {/* Concentric rings */}
                <div className="absolute top-1/4 right-[5%] w-[800px] h-[800px] rounded-full border border-amber-500/10 animate-[spin-slow_40s_linear_infinite]" />
                <div className="absolute top-1/4 right-[5%] w-[600px] h-[600px] rounded-full border border-amber-500/20 animate-[spin-slow-reverse_30s_linear_infinite]" />
            </div>
        ),
    };
