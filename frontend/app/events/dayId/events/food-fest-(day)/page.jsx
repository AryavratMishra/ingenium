...
export default function FoodFestDayPage() {
    ...
    const eventData = {
        ...
        time: "11:00 - 18:00",
        venue: "HJB Ground",
        video: "/events_videos/ff1.mp4",
        theme: {
            bg: "from-emerald-900/60 to-black",
            accent: "text-emerald-400",
            border: "border-emerald-400/30",
            buttonBg: "bg-emerald-500",
            glow: "shadow-[0_0_40px_rgba(52,211,153,0.4)]",
        },
        description: `Refuel the system. The daytime Food Fest is a culinary exhibition bringing together local favorites, diverse cuisines, and quick energy boosts to keep you running through the festival's demanding schedule.

Whether you need a full re-initialization or just a quick power-up between events, explore a matrix of stalls offering everything from traditional street food to contemporary fusions. Stay hydrated. Stay energized.`,
        tags: ["FESTIVAL", "CATERING", "REFRESHMENT"],
        backgroundElements: (
            <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden flex items-end">
                ...
                {[...Array(20)].map((_, i) => (
                    <div
                        key={i}
                        className="absolute rounded-full border border-emerald-400/20 flex items-center justify-center animate-[float-up_4s_ease-in_infinite]"
                        style={{
