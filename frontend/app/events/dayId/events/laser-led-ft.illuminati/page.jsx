...
export default function LaserLedPage() {
    ...
    const eventData = {
        ...
        time: "20:10 - 20:40",
        venue: "NCC Ground",
        video: "/events_videos/illuminati_web.mp4",
        theme: {
        ...
        description: `A visual spectacle that rewrites the night sky. Illuminati brings their signature Laser LED show, combining extreme-powered optical manipulation with precise rhythmic synchronization.

Prepare for a 30-minute assault on the senses. High-intensity coherent light streams will map across the audience and architecture, constructing 3D volumetric shapes that glitch, pulse, and shift in mid-air.`,
        tags: ["HEADLINER", "LASER", "SPECTACLE"],
        backgroundElements: (
            <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
                {/* Sweeping Lasers Base */}
                <div className="absolute bottom-[-10%] left-[20%] w-[2px] h-[150%] bg-blue-500 origin-bottom shadow-[0_0_20px_rgba(59,130,246,0.9)] animate-[laser-sweep_3s_ease-out_infinite]" />
                <div className="absolute bottom-[-10%] right-[30%] w-[2px] h-[150%] bg-cyan-400 origin-bottom shadow-[0_0_20px_rgba(34,211,238,0.9)] animate-[laser-sweep-rev_4s_ease-out_infinite_0.5s]" />
                <div className="absolute bottom-[-10%] left-[40%] w-[2px] h-[150%] bg-blue-400 origin-bottom shadow-[0_0_20px_rgba(96,165,250,0.9)] animate-[laser-sweep_5s_ease-out_infinite_1.5s]" />
            </div>
        ),
    };
