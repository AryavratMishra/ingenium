...
export default function TronActPage() {
    ...
    const eventData = {
        ...
        description: `A brief, high-impact intersection of technology and choreography. The Tron Act utilizes custom-built wireless LED arrays synced to a hard-hitting electronic score.

Watch as dancers map out the dark stage with trails of neon blue, creating ephemeral geometry that pulses and shifts to the beat. This 10-minute performance represents the perfect synthesis of hardware engineering and performing arts.`,
        tags: ["PERFORMANCE", "LED", "CHOREOGRAPHY"],
        backgroundElements: (
            <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
                {/* Tron Trails */}
                <div className="absolute top-[20%] right-[-20%] w-[120%] h-1 bg-gradient-to-r from-transparent via-cyan-400/80 to-transparent shadow-[0_0_15px_rgba(34,211,238,0.8)] animate-[lightcycle_2s_linear_infinite]" />
                <div className="absolute top-[40%] right-[-20%] w-[120%] h-1 bg-gradient-to-r from-transparent via-cyan-400/60 to-transparent shadow-[0_0_15px_rgba(34,211,238,0.8)] animate-[lightcycle_2.5s_linear_infinite_1s]" />

                {/* Neon Grid Base */}
                <div className="absolute bottom-0 left-0 w-full h-[30%] bg-[linear-gradient(rgba(34,211,238,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(34,211,238,0.1)_1px,transparent_1px)] bg-[size:40px_40px] [transform:perspective(500px)_rotateX(60deg)] origin-bottom opacity-50" />
            </div>
        ),
    };
