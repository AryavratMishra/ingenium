...
export default function StandUpComedyPage() {
    ...
    const eventData = {
        ...
        time: "20:45 - 21:30",
        venue: "NCC Ground",
        video: "/events_videos/ashish.mp4",
        theme: {
        ...
        description: `A necessary break from the intense compilation of the day. Ashish Solanki takes the stage to execute a set guaranteed to bypass your firewall and induce absolute laughter.

Join thousands of fellow participants for 45 minutes of brilliant observational comedy, tech-adjacent humor, and relatable crowd work. Decompress before the final DJ act of the night.`,
        tags: ["HEADLINER", "COMEDY", "ENTERTAINMENT"],
        backgroundElements: (
            <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
                {/* Spotlight arcs */}
                <div className="absolute bottom-[-10%] left-[30%] w-[20%] h-[120%] bg-gradient-to-t from-blue-500/30 to-transparent blur-2xl origin-bottom animate-[spotlight-swing_6s_ease-in-out_infinite]" />
                <div className="absolute bottom-[-10%] right-[30%] w-[20%] h-[120%] bg-gradient-to-t from-blue-400/30 to-transparent blur-2xl origin-bottom animate-[spotlight-swing_7s_ease-in-out_infinite_reverse]" />

                {/* Subtle floating particles (laughter) */}
                {[...Array(15)].map((_, i) => (
                    <div
                        key={i}
                        ...
                        style={{
                            ...
                            animation: `float-up ${Math.random() * 3 + 2}s ease-in-out infinite`,
