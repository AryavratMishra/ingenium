...
export default function SpicMacayPage() {
    ...
    const eventData = {
        ...
        video: "/events_videos/spicmacay.mp4",
        theme: {
        ...
        description: `A harmonious convergence of classical roots and modern energy. SPIC MACAY brings an immersive cultural performance, bridging generations through the profound language of Indian classical music and dance.

Witness maestros weave rhythms that transcend time, creating an atmosphere of spiritual and artistic elevation. This performance is a testament to the enduring power of our heritage, resonant within the high-tech landscape of the festival.`,
        tags: ["CULTURE", "HERITAGE", "PERFORMANCE"],
        backgroundElements: (
            <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden flex items-center justify-center">
                {/* Abstract Vinyl / Mandala */}
                <div className="absolute top-1/2 left-[80%] md:left-3/4 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] opacity-20">
                    <div className="absolute inset-0 border-[2px] border-rose-500/30 rounded-full animate-[spin-vinyl_20s_linear_infinite] border-dashed" />
                    <div className="absolute inset-8 border-[4px] border-rose-400/20 rounded-full animate-[spin-reverse_15s_linear_infinite]" />
                    <div className="absolute inset-16 border-[1px] border-rose-300/40 rounded-full animate-[spin-vinyl_25s_linear_infinite]" />
                    <div className="absolute inset-24 border-[2px] border-rose-500/20 rotate-45 animate-[spin-reverse_30s_linear_infinite] border-dotted" />
                </div>
                {/* Glowing dust */}
                {[...Array(15)].map((_, i) => (
                    <div
                        key={`dust-${i}`}
                        className="absolute rounded-full bg-rose-400/40 blur-[2px]"
                        style={{
