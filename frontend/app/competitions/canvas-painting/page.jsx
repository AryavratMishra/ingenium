...
export default function KalakritiPS() {
  ...
  const competitionData = {
    ...
    registrationPath: "/registration?competition=canvas-painting",
    fee: "₹600",
    prizes: {
      first: "12,000",
      second: "5,000",
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6 border-b border-orange-500/20 pb-8">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-black tracking-tighter text-white uppercase italic leading-none">
              {competitionData.name.split(" ")[0]}{" "}
              <span className="text-orange-500">
                {competitionData.name.split(" ")[1]}
              </span>
            </h1>
            <p className="text-xs text-orange-500/80 tracking-[0.3em] uppercase font-bold">
              {competitionData.org} // PROTOCOL: ART_SYNTHESIS
            </p>
          </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-5 bg-orange-600 text-black font-black uppercase tracking-[0.2em] rounded-xl flex items-center justify-center gap-3 transition-all shadow-lg shadow-orange-900/20 cursor-not-allowed!"
            >
