...
export default function RegistrationDeadlineDisclaimer({ competition, deadline }) {
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 space-y-2">
                ...
                <p className="text-[11px] md:text-[12px] leading-relaxed text-blue-100/80 font-mono">
                  ...
                  <span className="font-bold">{competition}</span> is{" "}
                  <span className="font-bold">{deadline}</span>. Please register
                  accordingly.
                </p>
              </div>
